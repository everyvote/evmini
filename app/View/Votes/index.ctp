<div class="votes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('candidacy_id'); ?></th>
			<th><?php echo $this->Paginator->sort('comment_id'); ?></th>
			<th><?php echo $this->Paginator->sort('stances_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($vote['Vote']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($vote['Vote']['candidacy_id']); ?>&nbsp;</td>
		<td><?php echo h($vote['Vote']['comment_id']); ?>&nbsp;</td>
		<td><?php echo h($vote['Vote']['stances_id']); ?>&nbsp;</td>
		<td class="actions">
